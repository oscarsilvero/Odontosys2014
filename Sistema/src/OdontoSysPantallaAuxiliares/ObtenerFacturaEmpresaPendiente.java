 ...
 * @author user
 */
public class ObtenerFacturaEmpresaPendiente extends javax.swing.JDialog {

    public static FacturaEmpresa fac = null;

    public ObtenerFacturaEmpresaPendiente(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ObtenerFacturaEmpresaPendiente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ObtenerFacturaEmpresaPendiente dialog = new ObtenerFacturaEmpresaPendiente(new javax.swing.JFrame(), true);
